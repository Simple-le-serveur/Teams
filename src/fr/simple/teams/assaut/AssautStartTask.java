...
public class AssautStartTask extends BukkitRunnable {
	...
	public AssautStartTask(AssautData assaut, Teams teams) {
		this.assaut = assaut;
		this.teams = teams;
	...
	public void run() {
		...
		if (decompte == 0) {
			new AssautTask(assaut, teams, bar).runTaskTimer(teams, 0L, 20L);
			cancel();
		}
